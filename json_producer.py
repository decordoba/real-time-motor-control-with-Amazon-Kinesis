...
""")
    ...
    parser.add_argument("-p", "--period", dest="period", type=int,
                        help="Period to wait between sending sensor data. If not set, data will be sent as fast as possible.",
...
def main():
    ...
    while True:
        ...
        try:
            ...
            print("Sent data '{:.5f}' from sensor '{}' into stream '{}'.".format(obj["value"], obj["sensor"], stream_name))
        except Exception as e:
            print("Encountered an exception while trying to put record sensor data into stream '{}'.".format(stream_name))
