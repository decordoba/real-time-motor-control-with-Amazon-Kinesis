...
Send goals as json objects into a selected stream. Works well with pid_controller.py.
""")
...
def main():
    ...
    while len(usr_input) == 0 or usr_input[0].lower() != "q":
        ...
        try:
            ...
            print("Error in position value.")
            continue
        if (pos > 180 or pos < -180) and pos != 999:
            print("Error in position value.")
            continue

        # Create object
        obj = {}
        obj["msg_type"] = 2  # type 2 refers to motor postion
        obj["value"] = pos
        ...
        try:
            ...
            print("{}. Sent motor position '{:.2f}' into stream '{}'.".format(obj["sequence"],
                                                                           obj["value"],
                                                                           stream_name))
